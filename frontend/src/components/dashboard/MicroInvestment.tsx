...
export function MicroInvestment() {
  return (
    <Card className="h-full flex flex-col border-neutral-200 min-h-0">
      ...
      <CardContent className="p-3 lg:p-4 pt-0 flex-1 flex flex-col justify-between min-h-0">
        <div className="flex-1 flex flex-col min-h-0">
          <div className="flex items-center gap-2 mb-2 shrink-0">
            <div className="bg-neutral-50 rounded-md p-2 border border-neutral-100 flex-1 flex flex-col justify-center items-center">
