...
export function WhatIfSimulator() {
  return (
    <Card className="h-full flex flex-col group overflow-hidden relative border-neutral-200 min-h-0">
      ...
      <CardHeader className="p-3 lg:p-3 pb-2 shrink-0 relative z-10">
      ...
      <CardContent className="p-3 lg:p-3 pt-0 flex-1 flex flex-col justify-between relative z-10 min-h-0">
        ...
        <div className="flex flex-row items-center justify-between gap-3 mt-auto shrink-0">
          <Link href="/simulator?scenario=payment" className="flex-1 py-2 px-3 mt-2 bg-white text-neutral-800 border border-neutral-200 text-xs font-semibold rounded-lg hover:bg-neutral-50 hover:border-neutral-300 transition-all shadow-sm flex items-center justify-center gap-2 shrink-0">
          Explore Scenario
          </Link>
